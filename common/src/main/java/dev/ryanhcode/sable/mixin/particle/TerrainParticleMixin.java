...
public abstract class TerrainParticleMixin extends Particle {
    ...
    private int sable$getLightColor(final BlockAndTintGetter blockAndTintGetter, final BlockPos blockPos, final Operation<Integer> original, @Local final int existingColor) {
