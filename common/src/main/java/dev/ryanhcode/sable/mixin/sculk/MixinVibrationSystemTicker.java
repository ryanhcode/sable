...
public interface MixinVibrationSystemTicker {
    ...
    private static Vec3 useGlobalPos(final VibrationInfo instance, final Operation<Vec3> original,
    ...
    private static PositionSource useGlobalDestPos(final VibrationSystem.User instance, final Operation<PositionSource> original,
                                                @Local(argsOnly = true) final ServerLevel level) {
